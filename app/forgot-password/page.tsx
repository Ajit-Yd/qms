...
export default function ForgotPasswordPage() {
  ...
  return (
    <main className="min-h-screen bg-[#EEF2FA] p-6 text-slate-800">
      <form onSubmit={(event) => { event.preventDefault(); setSent(true); }} className="animate-in mx-auto mt-16 max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_8px_32px_rgba(16,24,40,0.08)]">
        ...
        <Button type="submit" variant="primary" size="lg" fullWidth className="mt-4">Send instructions</Button>
